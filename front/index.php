	...
	while($row = $res->fetch_assoc()){
		...
		if($res1->num_rows > 0){
			while($row1 = $res1->fetch_assoc()){
				echo "<li><a href= "; 
				 if($_SESSION['logged']==1) echo "'category.php?category=".$row['category']."&title=".$row1['title'];
			else echo "'../theme/login_page.php";	 
			echo "'>".$row1['title']."</a></li>";
			}	
		}
		echo "</ul></div>";
	} 	
...
<?php   if($_SESSION['logged']==1) {
		echo "<a  href='profile.php'><img src='../theme/";
		 echo $photo ;
		echo "' style='float:right; position: relative ; top:15px; left: 23px; width:5% ; height:5% ; border-radius:50%;' alt='hi' ></a> ";
}
	else 
		echo   "<a href='../theme/login_page.php'  style='float:right; position:relative;left:5px;' class='btn btn-primary navbar-btn'><span class='hidden-sm'>Log in</span></a>";     ?>
	 <a href=<?php if($_SESSION['logged']==1) echo "'cart.php'";
			else echo "'../theme/login_page.php'";	 ?>
  style="float:right;" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"><?php echo $num; ?> Items in Cart</span></a>
        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="img/electronics.jpeg" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/furniture.jpeg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/clothing.jpeg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/grocery.jpeg" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                    ...
                    <div class="same-height-row">
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h3 style="color:#348e7b;">We love our customers</h3>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h3 style="color:#348e7b;" >Best prices</h3>
                                <p>You will get the best products for cheapest prices and big discounts on almost all products.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h3 style="color:#348e7b;" >100% satisfaction guaranteed</h3>
 ...
 _________________________________________________________ -->
        <div id="footer" data-animate="fadeInUp">
			...
			<div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href=<?php if($_SESSION['logged']==1) echo "'profile.php'";
			else echo "'../theme/login_page.php'";	 ?> >Profile</a>
                            </li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href=<?php if($_SESSION['logged']==1) echo "'contact.php'";
			else echo "'../theme/login_page.php'";	 ?> >About us</a>
                        </ul>

...
$stmt->close();
if(!$flag){
	$sql3="delete from cart where username='$uname'";
                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <h3><?php if(!$flag) echo "Thank You</h3>
                                <h4 class='text-muted'>Your order was placed successfully.</h4>";
				else echo "Sorry</h3>
                                <h4 class='text-muted'>Your order couldn't be placed as your demand of ".$excess." is more than our store</h4";?>
